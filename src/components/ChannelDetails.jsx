...
const ChannelDetails = ({ info }) => {
  return (
    <>
      ...
      <div className="text-neutral-700 justify-between">
        <div className="flex items-center">
          <div className="flex h-14 pb-3 items-center">
            <div className="flex mt-3 mr-3">
              ...
              <div className="flex flex-col text-start mr-6">
                <div className="text-base font-semibold align-middle">
                  {info?.snippet?.channelTitle}
                </div>
                <div className="text-xs text-zinc-500 mr-1 align-middle">
                  100k subscribers
                </div>
              </div>
              <div>
                <button className="bg-neutral-800 text-white text-[13px] h-9 w-24 rounded-r-full rounded-l-full font-semibold">
                  Subscribe
                </button>
              </div>
            </div>
            <div className="flex right-0 relative">
              ...
              <button className="flex items-center justify-center w-9 bg-neutral-100 h-9 rounded-l-full rounded-r-full">
